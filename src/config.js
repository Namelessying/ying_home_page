const config = {
  ...
  projectcards:[ 
    ...
    {go:"💖 赞助",img:"/img/sponsor.jpg",title:"<span style='color: rgb(166, 52, 55);'>赞助支持</span>",subtitle:"感谢您的支持与鼓励", text:"如果您喜欢我的作品，可以考虑给我一些支持，这将帮助我创作更多优质内容！",url:"/sponsor/",show:false},
  ],
